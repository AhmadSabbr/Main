...
function NovaLib:CreateWindow(Settings)
	...
	function Window:CreateTab(TabSettings)
		...
		function Tab:CreateConfigList()
			...
			listOptionNameLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			listOptionNameLabel.BackgroundTransparency = 1
			listOptionNameLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
			listOptionNameLabel.BorderSizePixel = 0
			listOptionNameLabel.Position = UDim2.new(-0.0714285746, 0, 0, 0)
			listOptionNameLabel.Size = UDim2.new(0, 95, 0, 35)
			...
			listOptionNameLabel.ClipsDescendants = true
		...
		function Tab:CreateDropdown(Settings)
			...
			optionNameLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			optionNameLabel.BackgroundTransparency = 1
			optionNameLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
			optionNameLabel.BorderSizePixel = 0
			optionNameLabel.Size = UDim2.new(0, 111, 0, 35)
			...
			optionNameLabel.ClipsDescendants = true
