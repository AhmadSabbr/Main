...
function NovaLib:CreateWindow(Settings)
	...
	notificationFrameHolder.Parent = Library
	...
	notificationFrameHolder.Position = UDim2.new(0.863, 0,0.018, 0)
	...
	function Window:CreateTab(TabSettings)
		...
		tabButton.MouseButton1Click:Connect(function()
			...
			for _, v in pairs(tabsContainer:GetChildren()) do
				if v:IsA("Frame") and v:FindFirstChild("tabButton") then
					v.BackgroundTransparency = 1
					v.tabButton.Text = v.tabButton.Name:gsub("Tab_", "")
				end
			end

			featuresContainer.Visible = true
			tabHolder.BackgroundTransparency = 0.6
			tabButton.Text = "<b>" .. tabButton.Name:gsub("Tab_", "") .. "</b>"
		end)
