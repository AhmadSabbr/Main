...
function NovaLib:CreateWindow(Settings)
	...
	function Window:CreateTab(TabSettings)
		...
		function Tab:CreateConfigList()
			...
			Instance.new("UICorner", configListHolder)

			local title = Instance.new("TextLabel")
			title.Parent = configListHolder
			title.BackgroundTransparency = 1
			title.Size = UDim2.new(0,300,0,50)
			title.Font = Enum.Font.Arimo
			title.RichText = true
			title.Text = "<b>Config List</b>"
			title.TextColor3 = Color3.fromRGB(255,255,255)
			title.TextSize = 14
			title.TextXAlignment = Enum.TextXAlignment.Left
			...
			button.Parent = configListHolder
			button.BackgroundTransparency = 1
			button.Position = UDim2.new(0.5566,0,0.14,0)
			...
			holder.Parent = configListHolder
			holder.BackgroundColor3 = Color3.fromRGB(74,13,135)
			holder.Position = UDim2.new(0.517,0,1,0)
			holder.Size = UDim2.new(0,134,0,0)
			...
			local function resize()
				holder.Size = UDim2.new(0,134,0,#self._configs*30)
			end
			...
			for _,file in pairs(listfiles(PlayerFolder)) do
				...
				if name then createOption(name) end
			end
			...
			self._configOptionButton = button
			self._configOptionsHolder = holder
		end
		...
		function Tab:CreateDropdown(Settings)
			...
			local holder = Instance.new("Frame")
			holder.Parent = self.featuresContainer
			holder.BackgroundColor3 = Color3.fromRGB(86,8,125)
			holder.BackgroundTransparency = 0.75
			...
			button.BackgroundTransparency = 1
			button.Position = UDim2.new(0.49,0,0.14,0)
			...
			list.Parent = holder
			list.BackgroundColor3 = Color3.fromRGB(74,13,135)
			list.Position = UDim2.new(0.517,0,1,0)
			list.Size = UDim2.new(0,134,0,0)
			list.Visible = false
			...
			for _,opt in ipairs(Options) do create(opt) end
			list.Size = UDim2.new(0,134,0,#Options*30)
