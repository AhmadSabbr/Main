local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/AhmadSabbr/Main/refs/heads/main/Deobfuscates/Muscle%20Masters.lua"))()
...
local player = Players.LocalPlayer  -- pastikan ini LocalScript

-- Tambahkan paragraf dengan nama player
Tab:AddParagraph("Deobfuscated By ZTX", "Welcome, " .. player.Name)
